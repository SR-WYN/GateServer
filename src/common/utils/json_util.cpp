// json_util.cpp - JSON 解析与响应构建工具实现
#include "json_util.h"
#include "Log.h"
...
Json::Value utils::json::parseRequestBody(std::shared_ptr<HttpConnection> conn)
{
...
void utils::json::makeJsonResponse(std::shared_ptr<HttpConnection> conn, const Json::Value &root)
{
...
void utils::json::makeErrorResponse(std::shared_ptr<HttpConnection> conn, int errorCode)
{
    Json::Value root;
